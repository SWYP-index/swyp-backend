...
import com.swyp.index.global.exception.DuplicateEmailException;
import com.swyp.index.global.exception.DuplicateNicknameException;
import com.swyp.index.global.exception.TokenException;
import com.swyp.index.infrastructure.jwt.JwtTokenProvider;
import com.swyp.index.repository.UserRepository;
import com.swyp.index.infrastructure.mail.SmtpMailService;
...
public class AuthService {
    ...
    //유효한 리프레시 토큰을 사용하여 새로운 액세스 토큰과 리프레시 토큰을 재발급
    @Transactional
